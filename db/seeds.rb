...
waldo.create_image({ name: 'waldo.jpg'})
wizard.create_image({ name: 'wizard.jpg'})
wenda.create_image({ name: 'wenda.jpg'})
odlaw.create_image({ name: 'odlaw.jpg'})
woof.create_image({ name: 'woof.jpg'})
